    ...
    <div className="rp-page">
      ...
      <section className="rp-hero">
        ...
        <div className="rp-hero-content">
          ...
          <a href="https://wa.me/40517508772?text=Bun%C4%83!%20Vreau%20s%C4%83%20%C3%AEncep%20s%C4%83%20folosesc%20RSistems." className="rp-hero-btn" target="_blank" rel="noopener noreferrer">
            Începe acum
